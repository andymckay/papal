...
raw_parsers = (
    ...
    ['Refund declined', 'refund_declined'],
    ...
    ['Checking refund permission for token', 'devhub_checking_refund'],
    ['AddonPremium', 'devhub_addonpremium'],
    ['Refund error', 'refund_error'],
    ['Got refund token', 'devhub_refund_token'],
    ['Ignoring', 'ipn_ignoring'],
    ["u*'[\w+]+?'#012<WSGIRequest", 'ipn_fatal'],
    ['Unknown status:', 'ipn_ignoring'],
    ['Paypal returned error for token', 'devhub_checking_refund_error'],
    ['\(2003, "Can', 'mysql_error'],
    ['Got preapproval', 'pre_approval_setup'],
    ['Preapproval key created', 'pre_approval_setup'],
    ['Preapproval key removed', 'pre_approval_removed'],
    ['Using preapproval', 'purchase_pre_approval']
)
